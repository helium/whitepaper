...
\paragraph{Devices and Miners belonging to the same OUI}
Devices and Miners belonging to the same Organizationally Unique Identifier (OUI) do not need to pay data transport fees to themselves. This allows users building devices and network coverage to take advantage of their own deployments without having to needlessly transfer tokens back and forth with themselves.
...
Miners who move physical location will need to assert a new location, and pay the new staking fee. Miners who do not pay the staking fee can continue to operate their gateway as a WHIP-compatible wireless access point, but cannot participate in the mining process and any blocks submitted will be ignored by the network.
