...
\begin{equation} \label{score}
	\phi_h = \begin{cases}
		\phi_{h-1} - \delta_h, &if \phi_{h-1} = \phi_max.\\
		\phi_{h-1} + \epsilon_{h-1} - \delta_h, &{otherwise}.
	\end{cases}
\end{equation}
...
\begin{equation} \label{recurrence}
	\phi_h = \begin{cases}
		\phi_{h-1} - \delta_h, &if \phi_{h-1} = \phi_max.\\
		\phi_{h-1} + \frac{\phi_{h-1}}{\sqrt{\phi_{h-1}} + (\left\lvert1 - \sqrt{1 - (\phi_{h-1} - 1)^2}\right\rvert \eta_{h-1})^{-2}} -\delta_h, &{otherwise}.
	\end{cases}
\end{equation}
