...
The following are tasks that we are actively working on:

\begin{itemize}
    \item The WHIP wireless protocol specification
    \item 
\end{itemize}

We plan to investigate or partner with interested parties to extend our ideas into other physical layers such as WiFi, Bluetooth and Cellular, as well as explore the potential for the delivery of 5G 60GHz+ mmWave connectivity through a similar mechanism. Additionally we plan to continue to research and implement more \emph{Proofs-of-Coverage} to keep the network secure as it grows.
