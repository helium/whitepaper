...
\begin{equation} \label{score}
	\phi\textsubscript{h} = \begin{cases}
		\phi\textsubscript{h-1}, &if \phi\textsubscript{h-1} = \phi\textsubscript{max}.\\
		\phi\textsubscript{h-1} + \epsilon\textsubscript{h-1}, &{otherwise}.
	\end{cases}
\end{equation}

Substituting the values from \ref{alpha}, \ref{epsilon} to \ref{score}, we get the following recurrence relationship:
\begin{equation} \label{recurrence}
	\phi\textsubscript{h} = \begin{cases}
		\phi\textsubscript{h-1}, &if \phi\textsubscript{h-1} = \phi\textsubscript{max}.\\
		\phi\textsubscript{h-1} + \frac{\phi\textsubscript{h-1}}{\sqrt{\phi\textsubscript{h-1}} + (\lvert1 - \sqrt{1 - (\phi\textsubscript{h-1} - 1)^2}\rvert \cdot \eta\textsubscript{h-1})^{-2}}, &{otherwise}.
	\end{cases}
\end{equation}
