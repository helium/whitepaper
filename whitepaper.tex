...
\todo{THIS DIAGRAM SHOULD ALSO BE UPDATED TO BETTER REPRESENT THE T1 -> T -> TL TYPE OF FLOW. ALSO THE SIGNED RECEIPTS ARE NOW IN THE FORM OF ${K_S = \left(S || \beta || \upsilon\right)}$}
