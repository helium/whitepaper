...
\begin{tabular}{l l}
	...
	P(g), &probability of g being selected as target\\
	$\phi$\textsubscript{G}, &score of god gateway\\
	$\phi$\textsubscript{0}, &score of g initially\\
	$\phi$\textsubscript{h}, &score of g at height h\\
...
\begin{split}
\alpha\textsubscript{h} &= e(\phi\textsubscript{h-1}, \eta\textsubscript{h-1}) \\
&= \lvert1 - \sqrt{1 - (\phi\textsubscript{h-1} - 1)^2}\rvert \cdot \eta\textsubscript{h-1}\\
\epsilon\textsubscript{h} &= f(\phi\textsubscript{h-1}, \alpha\textsubscript{h})\\
&= \frac{\phi\textsubscript{h-1}}{\sqrt{\phi\textsubscript{h-1}} + \frac{1}{(\alpha\textsubscript{h})^2}}\\
\phi\textsubscript{h} &= g(\phi\textsubscript{h-1}, \eta\textsubscript{h-1}, \phi\textsubscript{max})\\
&= \phi\textsubscript{h-1} + \epsilon\textsubscript{h}
\end{split}
\end{equation*}\newline
...
\begin{split}
\phi\textsubscript{h} &= \phi\textsubscript{h-1} + \frac{\phi\textsubscript{h-1}}{\sqrt{\phi\textsubscript{h-1}} + (\lvert1 - \sqrt{1 - (\phi\textsubscript{h-1} - 1)^2}\rvert \cdot \eta\textsubscript{h-1})^2}
\end{split}
\end{equation*}\newline
