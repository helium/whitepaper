...
\begin{split}
\delta\textsubscript{h} &\propto \frac{1}{\phi\textsubscript{h-1}}
\end{split}
\end{equation}
...
Substituting the values from (\ref{alpha}), (\ref{epsilon}), (\ref{delta}) to (\ref{score}), we get the following recurrence relationship:
